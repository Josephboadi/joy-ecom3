...
class Item(models.Model):
    ...
    def get_price_dividedby_discount(self):
        return self.discount_price / self.price

    def multiply_result_byhundred(self):
        return self.get_price_dividedby_discount() * 100

    
    def get_percentage_discount(self):
        return 100 - self.multiply_result_byhundred()
